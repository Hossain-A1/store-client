...
const PositiveReviews = () => {
  ...
  return (
    <div className='flex max-md:flex-col  flex-wrap gap-5 items-center'>
      <div className='w-1/4 max-md:w-full border-2 space-y-3 p-5  border-blue'>
      ...
      <div className='w-1/4 max-md:w-full border-2 space-y-3 p-5  border-blue'>
        ...
        <div className='w-full'>
          <Reviews review={item} />
          <strong className='text-justify text-sm'>
            "SkyhawkForge has won me over. The drone is sleek, powerful, and the
        ...
        <div className='flex flex-wrap gap-5'>
          ...
          <div className='w-1/4 max-md:w-full border-2 space-y-3 p-5  border-blue'>
            ...
            <div className='w-full'>
              <Reviews review={item} />
              <strong className='text-justify text-sm'>
                "SkyhawkForge drones are a game-changer. After the first flight,
          ...
          <div className='w-1/4 max-md:w-full border-2 space-y-3 p-5  border-blue'>
            ...
            <div className='w-full'>
              ...
              <strong className='text-justify text-sm'>
                ...
                premium, and the flight experience is nothing short of amazing."
              </strong>
            </div>
          </div>
          <div className='w-1/4 max-md:w-full border-2 space-y-3 p-5  border-blue'>
